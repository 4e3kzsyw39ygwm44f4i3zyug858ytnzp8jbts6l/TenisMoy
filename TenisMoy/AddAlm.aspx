<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAlm.aspx.cs" Inherits="TenisMoy.AddAlm" %>
...
<body class="bg-secondary">
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="display-5">Crear Almacen</h1>
                <p class="lead">
                    Al crear un almacen podrá asignarlo a una tienda y tener existencias por separado
                </p>
                <hr class="my-4" />
                <p>
                    Escriba un nombre para el almacen y el sistema le asignará un id
                </p>

                <div class="form-group ">
                    <label for="txtCodalm">Nombre:</label>
                    <asp:TextBox runat="server" ID="txtCodalm" class="form-control col-sm-12 col-lg-3" type="text" />
                </div>
                <p class="lead">
