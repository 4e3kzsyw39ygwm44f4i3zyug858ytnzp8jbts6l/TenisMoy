<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFam.aspx.cs" Inherits="TenisMoy.AddFam" %>
...
<body class="bg-secondary">
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="display-5">Crear Familia</h1>
                <p class="lead">                    Al crear una familia podrá clasificar un producto, y podrá obtener reportes filtrados por familias                </p>
                ...
                <hr class="my-4" />
                <p>Escriba un nombre para la familia y el sistema le asignará un id.</p>
